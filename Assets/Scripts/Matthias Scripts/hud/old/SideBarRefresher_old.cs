...
public class SidebarRefresher_old : MonoBehaviour
{
    ...
    void Start()
    {
        statsTmp = GameObject.Find("Hud V2/SideBar/Stats").GetComponent<TextMeshProUGUI>();
        statChangeTmp = GameObject.Find("Hud V2/SideBar/ChangeStats").GetComponent<TextMeshProUGUI>();
